  ...
  return (
    <Box sx={{ py: 4 }}>
      <Container>
        <Typography
          variant="h5"
          sx={{ color: "rgb(55, 245, 242)", textTransform: "uppercase" }}
        >
          Our Blog
        </Typography>
            ...
            <Card sx={{ minWidth: 275, border: "2px solid red" }}>
              <CardContent>
                ...
                >
                  ...
                  minus dicta libero perspiciatis aperiam. Illo perferendis
                  neque aliquid, autem iure aspernatur temporibus expedita.
                  Quasi soluta placeat illum quam sint laudantium?
                </Typography>
              </CardContent>
            </Card>
          </Grid>
